<form id="js_productsFeed_form" method="post">
	<input type="hidden" name="id" value="<?php echo $feed->id;?>" id="js_productsFeed_id">
		...
		<div class="box p-3 js_productsFeed_type_box">
			...
			<div class="form-group">
				<label class="radio d-block">
					<input type="radio" name="productType" value="category" class="js_productsFeed_input_type" <?php echo ($feed->type == 'category') ? 'checked' : '';?>> Danh mục sản phẩm
				</label>
				...
				<label class="radio d-block">
					<input type="radio" name="productType" value="productsCustom" class="js_productsFeed_input_type" <?php echo ($feed->type == 'productsCustom') ? 'checked' : '';?>> Sản phẩm tùy chọn
				</label>
				<label class="radio d-block">
					<input type="radio" name="productType" value="products" class="js_productsFeed_input_type" <?php echo ($feed->type == 'products') ? 'checked' : '';?>> Tất cả sản phẩm
				</label>
			</div>
			<div class="productsFeed_products_box productsFeed_products" style="display: <?php echo ($feed->type == 'productsCustom') ? 'block' : 'none';?>;">
